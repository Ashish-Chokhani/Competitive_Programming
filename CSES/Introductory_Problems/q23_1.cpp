...
bool isInValidVisit(ll x,ll y){
	...
	if(visited[TOP_LEFT] && !visited[UP] && !visited[LEFT]) return true;
	if(visited[BOTTOM_LEFT] && !visited[LEFT] && !visited[DOWN]) return true;
	if(visited[TOP_RIGHT] && !visited[UP] && !visited[RIGHT]) return true;
	if(visited[BOTTOM_RIGHT] && !visited[RIGHT] && !visited[DOWN]) return true;
	return false;
}
